...
export const ConversationsIdView = ({ conversationId }: { conversationId: Id<"conversations"> }) => {
    ...
    const createMessage = useMutation(api.private.messages.craete);
    ...
    const updateConversationStatus = useMutation(api.private.conversations.updatedStatus);
            ...
            <div className="p-2">
                <Form {...form}>
                    <AIInput onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <AIInputToolbar>
                            <AIInputTools>
                                <AIInputButton disabled={conversation?.status === "resolved" || isEnhancing || !form.formState.isValid}
